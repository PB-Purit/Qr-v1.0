...
export const openingStations: Station[] = [
  {
    id: "open-1",
    label: "2.1 ร้านทองเยาวราช",
...
export const nightStations: Station[] = [
  ...
  },
  {
    id: "night-6",
    label: "3.6 Log (Night)",
    url: "https://script.google.com/macros/s/AKfycbyWV0pVza8L8YCmnXW2hOm4TX6j5Qb7CIucRFIo7qdLw7CSjFTy9gtje0_DPKcSCO41rA/exec",
  },
];

export const smartLogStore: Station = {
  id: "smart-log",
  label: "Smart Log Store",
  url: "https://script.google.com/macros/s/AKfycbwNxD9DOAtJUVp-goy2eOLqE8b9bC_J7-EN_UbCZIF4kdlUf1luvw_vCInS89fLByBbrw/exec",
};
